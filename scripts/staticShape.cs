...
function ShapeBaseData::onGetHP(%data, %obj) //Get current HP
{
%db = %obj.getDataBlock().getName(); //%data probably is the same thing, but I trust this more
%maxDMG = %db.maxDamage;
return %maxDMG - %obj.getDamageLevel();
}
